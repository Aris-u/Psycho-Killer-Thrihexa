...
function AudioController(_str_sfx_,_str_music_,_str_master_) constructor {
	global.__audio_controller__ = self
	list_audio = ds_list_create()
	
	global_sfx		= _str_sfx_;
	global_music	= _str_music_;
	global_master	= _str_master_;
...
function AudioPlayLoop(_sound_id, _au_type, _milli , _offset = 1) : AudioElement() constructor {
	sound_id	= _sound_id;
	type_		= _au_type;
	offset		= _offset;
	id_playind = noone;
